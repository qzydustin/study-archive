...
enum AttrType {
    attrString, attrInteger, attrReal, attrSymbol, attrNull
};
enum AttrOperator {
...
enum SelectType {
    selRange, selExact, selBoth, selUndefined
};
...
struct RID {
    ...
    int operator==(const RID rid) const { return pageNo == rid.pageNo && slotNo == rid.slotNo; };
